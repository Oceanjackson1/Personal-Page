...
description: "Execute read-only SQL queries against PostgreSQL databases. Use when: (1) querying PostgreSQL data, (2) exploring schemas/tables, (3) running SELECT queries for analysis, (4) checking database contents. Supports multiple database connections with ..."
category: "research"
source: "community"
author: "Community"
tags: ["read", "only", "postgres"]
date: 2026-03-20
---
