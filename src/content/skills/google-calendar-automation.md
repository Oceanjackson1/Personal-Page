...
description: "Interact with Google Calendar - list calendars, view events, create/update/delete events, and find free time. Use when user asks to: check calendar, schedule a meeting, create an event, find available time, list upcoming events, delete or update a..."
category: "workflow"
source: "community"
author: "Community"
tags: ["google", "calendar", "automation"]
date: 2026-03-20
---
