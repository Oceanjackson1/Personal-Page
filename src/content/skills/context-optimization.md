...
description: "This skill should be used when the user asks to 'optimize context', 'reduce token costs', 'improve context efficiency', 'implement KV-cache optimization', 'partition context', or mentions context limits, observation masking, context budgeting, or ..."
