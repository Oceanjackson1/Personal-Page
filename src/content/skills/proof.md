---
title: "Proof"
description: "Create, edit, comment on, and share markdown documents via Proof's web API and local bridge. Use when asked to 'proof', 'share a doc', 'create a proof doc', 'comment on a document', 'suggest edits', 'review in proof', or when given a proofeditor.a..."
